...
Look up "early onset breast cancer" in Google Scholar and pick a paper to skim.
    1. Link to paper: https://doi.org/10.1016/S0140-6736(03)12856-5
    2. What is one thing you learned from this paper:The lifetime risk of breast cancer ranges between 43 and 85%. 
...
```{r}
nrow(clinical) == nrow(old_clinical) + nrow(young_clinical)# write code here
```
...
Young people, or those under the age of 50 have a higher survival rate after 3500 days on the graph, this is likely due to the fact that the young people have passed away by this point. For the first 3500 days the survival rate of old people decline at a faster rate than the younger group.
...
write.csv(clinical, "/Users/JennaJacobs/Documents/USC/qbio490/qbio_490_jenna/brca_clinical_data.csv", row.names = FALSE)
```
