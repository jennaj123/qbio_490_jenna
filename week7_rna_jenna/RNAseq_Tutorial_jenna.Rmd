...
```{r}
rna_clinical <- read.csv("/Users/JennaJacobs/Documents/USC/qbio490/qbio_490_jenna/brca_rna_clincial_data.csv", header = TRUE)
rna_counts <-read.csv("/Users/JennaJacobs/Documents/USC/qbio490/qbio_490_jenna/brca_rna_count_data.csv", header = TRUE)
...
```{r}
TP53_ensembl <- rna_genes[TP53_mask, "gene_id"] # think about which column we should apply out mask to
...
which(rownames(rna_counts)==TP53_ensembl)

which(rownames(rna_genes)==TP53_ensembl)
which(rownames(rna_counts)==BRCA2_ensembl)

which(rownames(rna_genes)==BRCA2_ensembl)
...
The distribution of the two genes is very similiar, both are higher in frequency at lower counts. 
...
The median is low and there are many outliers above. This is significant as the two genes both have a low median but there are a large quantity of outliers.
----
...
There were more outliers in patients that did not survive more than 5 years. The median number of counts of BRCA2 was similar in both patient groups. This correlates with the majority of research available concerning BRCA2.
----
...
```{r}
# save files here
write.csv(rna_clinical, "//Users/JennaJacobs/Documents/USC/qbio490/qbio_490_jenna/brca_rna_clincial_data.csv", row.names = TRUE) write.csv(rna_genes, "/Users/JennaJacobs/Documents/USC/qbio490/qbio_490_jenna/brca_rna_gene_data.csv", row.names = FALSE) write.csv(rna_counts, "/Users/JennaJacobs/Documents/USC/qbio490/qbio_490_jenna/brca_rna_count_data.csv", row.names = FALSE)
```
