...
```{r setup}
    knitr::opts_knit$set(root.dir = normalizePath("/Users/jennajacobs/Documents/USC/qbio/attenu_cleaned.csv")) 
```
...
colour = c()
colour = ifelse(iris$Sepal.Width > x_mean & iris$Petal.Width > y_mean, "blue", ifelse(iris$Sepal.Width > x_mean & iris$Petal.Width < y_mean, "green", ifelse(iris$Sepal.Width < x_mean & iris$Petal.Width < y_mean, "red", "yellow")))
colour_factor = as.factor(colour)
plot(iris$Sepal.Width, iris$Petal.Width, col = colour_factor)
...
```{r}
write.csv(attenu_cleaned, "Users/JennaJacobs/Documents/USC/qbio/attenu_cleaned.csv") # in R, file paths are strings so don't forget the quotes!
```
...
```{r}
df <- read.csv("/Users/jennajacobs/Documents/USC/qbio/attenu_cleaned.csv", header = TRUE)
```
...
```{r}
# write code here
atennu_read_in = read.csv("/Users/jennajacobs/Documents/USC/qbio/attenu_cleaned.csv", header = TRUE)
```

We also oftentimes want to save our plots. You can do this as follows:

```{r}
jpg("/Users/jennajacobs/Documents/USC/qbio/attenu_cleaned.csv/plot.jpg") # choose any file extension, typically jpg and pdf are most common
...
```{r}
# write code here
jpeg("/Users/jennajacobs/Documents/USC/qbio/attenu_cleaned.csv")
